...
<div class="container my-3 d-flex justify-content-between align-items-center">
    <h4>Your Wallet Balance: ₹<span id="walletBalance">0</span></h4>
</div>
-->
<div class="container my-5">
    <form method="POST" class="form-row align-items-center bg-light p-4 rounded shadow" action="passbook.php" style="max-width: 100%; margin: auto;">
        ...
        <div class="col-auto">
            <button class="btn btn-primary btn-sm shadow-sm" type="submit">View Passbook</button>
        </div>
    </form>
</div>
...
<div class="container my-5">
    ...
    <div class="container">
        <div class="tree-root">
            <span class="tree-avatar"><i class="fa fa-shield-alt" aria-hidden="true"></i></span>
            <span class="tree-card-content">
        ...
        <?php
            ...
            if (isset($_SESSION['user_id'])) {
                ...
                echo "<p>Total Users in Chain: $userCount</p>"; // Display the total user count
            } else {
   ...
   <script>
        $(document).ready(function() {
            // Set initial wallet balance on page load
